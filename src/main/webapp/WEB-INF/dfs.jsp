    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3 d-flex flex-column">
            ...
            <div class="border p-3 mb-3" style="flex-grow: 1;">
                <p> На цій сторінці ви можете задати граф та побачити візуалізацію пошуку в глибину на ньому.</p>
...
<script>
    ...
    document.getElementById("run").addEventListener("click", async () => {
        ...
        const response = await fetch("/dfs?start=" + encodeURIComponent(start), {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify(graphData)
        });

        dfsSteps = await response.json();
        console.log(dfsSteps);

        // Start the animation
        stepIndex = 0;
        isAnimating = true;
        animateSteps(dfsSteps);
    });
